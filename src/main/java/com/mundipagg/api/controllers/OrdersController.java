...
public class OrdersController extends BaseController {
    ...
    private HttpRequest _buildCreateOrderRequest(
                final CreateOrderRequest body) throws IOException, APIException {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
    ...
    public GetOrderResponse updateOrderMetadata(
        ...
        HttpRequest _request = _buildUpdateOrderMetadataRequest(orderId, request);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void updateOrderMetadataAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildUpdateOrderMetadataRequest(orderId, request);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    public GetOrderResponse deleteAllOrderItems(
        ...
        HttpRequest _request = _buildDeleteAllOrderItemsRequest(orderId);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void deleteAllOrderItemsAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildDeleteAllOrderItemsRequest(orderId);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    public GetOrderItemResponse updateOrderItem(
        ...
        HttpRequest _request = _buildUpdateOrderItemRequest(orderId, itemId, request);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void updateOrderItemAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildUpdateOrderItemRequest(orderId, itemId, request);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    private HttpRequest _buildUpdateOrderItemRequest(
                final String orderId,
                final String itemId,
                final UpdateOrderItemRequest request) throws IOException, APIException {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
    ...
    public GetOrderItemResponse deleteOrderItem(
        ...
        HttpRequest _request = _buildDeleteOrderItemRequest(orderId, itemId);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void deleteOrderItemAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildDeleteOrderItemRequest(orderId, itemId);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    public GetOrderItemResponse createOrderItem(
        ...
        HttpRequest _request = _buildCreateOrderItemRequest(orderId, request);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void createOrderItemAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildCreateOrderItemRequest(orderId, request);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    private HttpRequest _buildCreateOrderItemRequest(
                final String orderId,
                final CreateOrderItemRequest request) throws IOException, APIException {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
    ...
    public GetOrderResponse updateOrderStatus(
        ...
        HttpRequest _request = _buildUpdateOrderStatusRequest(id, request);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
    ...
    public void updateOrderStatusAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                HttpRequest _request;
                try {
                    _request = _buildUpdateOrderStatusRequest(id, request);
                } catch (Exception e) {
                    callBack.onFailure(null, e);
                    return;
                }
    ...
    private HttpRequest _buildUpdateOrderStatusRequest(
                final String id,
                final UpdateOrderStatusRequest request) throws IOException, APIException {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
